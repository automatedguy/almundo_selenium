...
public class Constants {
    ...
    //URLS
    public static final String STAGING_URL = "https://st.almundo.com";
    ...
    public static final List<String> USER_MENU_LIST_AR = asList("Perfil", "Medios de pago", "Mis reservas", "Mis gustos", "Mis puntos", "Cerrar sesion");
    public static final List<String> USER_MENU_LIST_CO = asList("Perfil", "Medios de pago", "Mis reservas", "Cerrar sesion");
    public static final List<String> USER_MENU_LIST_MX = asList("Perfil", "Medios de pago", "Mis reservas", "Cerrar sesion");
