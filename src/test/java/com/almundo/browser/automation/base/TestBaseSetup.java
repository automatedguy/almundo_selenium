...
//                                        @Optional("Windows 10") String osType,
    ...
    private void initSauceLabsDriver(String methodName)  {
        String USERNAME = "automationcompany";
        String ACCESS_KEY = "d97e33ec-5407-4cb8-b86b-15b12b33b426";
    ...
    public void forceCheckoutV3(){
        try{
            PageUtils.waitUrlContains(driver, 60, "checkout", "Checkout V3");
    ...
    public void forceStaging(){
        try{
            PageUtils.waitUrlContains(driver, 60, "staging.almundo", "Staging");
        } catch(Exception time) {
