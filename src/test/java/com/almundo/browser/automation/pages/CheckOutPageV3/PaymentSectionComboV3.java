...
public class PaymentSectionComboV3 extends CheckOutPageV3 {
    ...
    public PaymentSectionComboV3 populatePaymentSectionV3(String paymentData, String container) {
        ...
        WebElement creditCardDdl =  driver.findElement(By.cssSelector(container + " div:nth-child(1) > div > select"));
        WebElement bankDdl =  driver.findElement(By.cssSelector(container + " div:nth-child(2) > div > select"));
        WebElement paymentDdl =  driver.findElement(By.cssSelector(container + " div:nth-child(3) > div > select"));
