...
public class PassengerSectionV3 extends CheckOutPage {
    ...
    public PassengerSectionV3 setFirstName(int index, String firstName){
        List<WebElement> firstNameList = driver.findElements(By.cssSelector("passengers-form #first_name"));
    ...
    public PassengerSectionV3 setlastName(int index, String lastNamePassenger){
        List<WebElement> lastNameList = driver.findElements(By.cssSelector("passengers-form #last_name"));
    ...
    public PassengerSectionV3 setDocumentNumber(int index, String documentNumberPassenger){
        List<WebElement> documentNumberList = driver.findElements(By.cssSelector("passengers-form #number"));
    ...
    public PassengerSectionV3 setDocumentEmisor(int index, String documentEmisorPassenger){
        List<WebElement> documentEmisorList = driver.findElements(By.cssSelector("passengers-form #documentEmisor"));
    ...
    public PassengerSectionV3 setDocumentExpiration(int index, String documentExpirationPassenger){
        List<WebElement> documentExpirationList = driver.findElements(By.cssSelector("passengers-form #documentExpiration"));
    ...
    public PassengerSectionV3 setBirthDay(int index, String birthdayPassenger){
        List<WebElement> birthDayList = driver.findElements(By.cssSelector("passengers-form #birthday"));
