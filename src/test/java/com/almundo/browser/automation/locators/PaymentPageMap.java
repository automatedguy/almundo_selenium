...
public enum PaymentPageMap {
    ...
    VER_15_BANCOS_MAS_LNK(By.xpath("//*[@id=\"ng-app\"]/div/div[4]/form/div[3]/fieldset/div[2]/div/div/div/div[1]/div[1]/div[2]/div/div/p[1]/span/span[1]")),
    VER_15_BANCOS_MAS_LNK_CLK(By.xpath("//input[contains(@class,'epp-space-right-8')]")),
    AMERICAN_EXPRESS_INP(By.xpath("//option[contains(.,'American Express')]")),
    CUOTAS_24(By.xpath("//option[contains(.,'24')]")),
    AMEX_01_CUOTAS_RDO(By.xpath("//input[contains(@id,'p_')]")),
