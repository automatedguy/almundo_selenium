...
public enum PaymentFlowMap {
    ...
    VER_BANCOS_01CUOTAS_LNK(By.xpath("//*[@id=\"ng-app\"]/div/div[4]/form/div[3]/fieldset/div[2]/div/div/div/div[1]/div[1]/div[1]/div/p[2]/span[1]")),
    VER_BANCOS_02CUOTAS_LNK(By.xpath("//*[@id=\"ng-app\"]/div/div[4]/form/div[3]/fieldset/div[2]/div/div/div/div[2]/div[1]/div[2]/div/div/p[1]/span/span[1]")),
    VER_BANCOS_LNK_CLK(By.xpath("//*[@id=\"ng-app\"]/div/div[4]/form/div[3]/fieldset/div[2]/div/div/div/div[2]/div[1]/div[2]/div/div/div")),
