...
public class RetailFlowSplittedInsuranceTest extends TestBaseSetup {
    ...
    @SuppressWarnings("Duplicates")
    @Test
    public void IntBookingFlowSplittedDepositCredit() {
    ...
    @SuppressWarnings("Duplicates")
    @Test
    public void IntBookingFlowSplittedCashTransfer() {
    ...
    @SuppressWarnings("Duplicates")
    @Test
    public void IntBookingFlowSplittedTransferCredit() {
    ...
    @SuppressWarnings("Duplicates")
    @Test
    public void IntBookingFlowSplitted3cards() {
